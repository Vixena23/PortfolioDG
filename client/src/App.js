...
function App() {
  ...
  return (
    ...
    {/* Navbar section */}
    <nav className="navbar navbar-expand-lg navbar-light bg-light ff fw-bold" id="navbar">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav mx-auto fw-bold ">
              <li className="nav-item">
                <a className="nav-link pe-5 active " aria-current="#about" href="#about">{t('sec1_navbar')}</a>
              </li>
              <li className="nav-item">
                <a className="nav-link pe-5" href="#projects">{t('sec4_navbar')}</a>
              </li>
              <li className="nav-item">
                <a className="nav-link pe-5" href="#technology">{t('sec3_navbar')}</a>
              </li>
              
              <li className="nav-item">
                <a className="nav-link pe-5" href="#contact">{t('sec5_navbar')}</a>
              </li>
              <li>
                <div className="mx-5 pe-5"></div>
              </li>
              <li className="nav-item ">
                  <div className="dropdown pe-lg-5 ms-lg-5 ">
